...
import { Stopwatch, Star, MapIcon, BellRing, ChevronDown } from "@boxicons/react"
...
export default function App() {
  ...
  return (
    <>
      <Helmet>
        <title>UrbanTransit</title>
      </Helmet>
      <div className="bg-bg-1">
        <AppCTA />
        <Header />
        <main className="px-6 pt-28 max-w-7xl relative left-[50%] translate-x-[-50%] pb-12">
