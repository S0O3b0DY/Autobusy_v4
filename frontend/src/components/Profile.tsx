...
import { doSignOut, doDeleteUser } from './../lib/authService.ts'
    ...
    return (
      <div ref={cardRef} className="w-full mx-auto bg-white dark:bg-zinc-950 border border-zinc-200/60 dark:border-zinc-800/60 overflow-hidden">
        ...
        <div className="py-4 px-4 space-y-3 max-w-120 relative left-[50%] -translate-x-[50%]">
          ...
          <button 
            onClick={doSignOut}
            className="w-full flex items-center justify-center gap-2 bg-red-50 dark:bg-red-950/20 text-red-600 font-black py-3 rounded-xl hover:bg-red-500 hover:text-white
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-2 hover:bg-red-800 dark:bg-red-900 hover:text-red-50 font-black py-3 rounded-xl bg-red-600 text-white
              transition-all active:scale-95 text-[11px] uppercase tracking-widest border border-red-100 dark:border-red-900/30 cursor-pointer"
          >
            <Trash size="xs" /> usuń konto
          </button>
